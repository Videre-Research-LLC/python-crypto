...
- store and retrieve encrypted values stored in a file (`get` or `set`)
...
commands:
    ...
    set       Encrypt a file using an RSA certificate
    get       Decrypt a file using an RSA certificate
...
/Users/me/Documents/my_file.txt.encrypted
```

The file can then be decrypted using:

```
crypto decrypt -k dev -f my_file.txt.encrypted
Using key: /Users/me/dev_key.bin
Opening encrypted key.
Enter key password:
```
...
```
crypto decrypt -f my_file.txt.encrypted
...
```
crypto set -s DEV -o database_password
...
```
crypto set -s DEV -o database_password -v my_secret_password
Using key: /Users/me/Documents/rsa_public.pem
...
```
crypto get -s DEV -o database_password
...
```
crypto set -s PROD -o database_password -v super-secret
...
```
crypto get -s PROD -o database_password
Using key: /Users/me/rsa_key.bin
Opening encrypted key.
Enter key password:
get
